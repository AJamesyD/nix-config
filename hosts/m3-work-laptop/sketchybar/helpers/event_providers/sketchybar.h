...
// Push-only Mach IPC for sending commands to sketchybar.
// Stripped from FelixKratz/SketchyBar helper/sketchybar.h:
// keeps only the sending side (no event_server_begin, no mach_server).
